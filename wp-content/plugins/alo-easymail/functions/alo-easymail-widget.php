...
function alo_em_show_widget_form ( ) {
	...
	if (is_user_logged_in()) {
		...
		{
			$html .= "    <td><input type='text' name='alo_em_opt_name' value='". $alo_em_opt_name ."' id='opt_name' maxlength='50' class='input-text news-nome' placeholder='Insira aqui seu nome' /></td>\n";
		} else {
			//$html .= "    <td><input type='text' name='alo_em_opt_name' value='' id='opt_name' maxlength='50' class='input-text' /></td>\n";
		}
		$html .= "  </tr>\n";
        $html .= "  <tr>\n";
        $html .= "    <td><input type='text' name='alo_em_opt_email' value='". $alo_em_opt_email ."' id='opt_email' maxlength='50' class='input-text' placeholder='Insira aqui seu e-mail' /></td>\n";
        $html .= "  </tr>\n";
